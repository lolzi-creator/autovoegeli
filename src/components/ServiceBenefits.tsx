...
const ServiceBenefits = () => {
  ...
  const items = [
    { icon: Shield, title: t('home.benefit_checked'), desc: t('home.benefit_checked_desc') },
    { icon: Wrench, title: t('home.benefit_service'), desc: t('home.benefit_service_desc') },
    { icon: Handshake, title: t('home.benefit_advice'), desc: t('home.benefit_advice_desc') },
    { icon: Clock, title: t('home.benefit_fast'), desc: t('home.benefit_fast_desc') },
  ];
  return (
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10 md:mb-14">
          <h2 className="text-2xl md:text-4xl font-bold text-gray-900">
            <span className="bg-gradient-to-r from-green-600 to-emerald-500 bg-clip-text text-transparent">{t('home.benefits_title')}</span>
          </h2>
          <p className="mt-3 text-gray-600 md:text-lg">{t('home.benefits_subtitle')}</p>
        </div>
