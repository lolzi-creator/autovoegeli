...
// Step 1: Get all available car brands from AutoScout24 (DYNAMIC)
...
async function getModelsForCarBrand(brandKey, brandName) {
  console.log(`🚗 Getting models for ${brandName}...`);
  
  try {
    const html = await fetchPage(`https://www.autoscout24.ch/de/hci/v2/5571/search?makeKey=${brandKey}`);
